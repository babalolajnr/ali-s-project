        ...
        <ul class="space-y-2 tracking-wide mt-8">
            ...
            <li>
                <a href="{{ route('principals.index') }}" aria-label="principals"
                    ...
                    <span class="-mr-1 font-medium">Principals</span>
                </a>
            </li>
            {{-- <li>
            ...
            <li>
                <a href="{{ route('records.index') }}" class="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20"
                        fill="currentColor">
